...
//--> Begin Class :: ODBCDriver
	public class ODBCDriver {
		...
		//--> Begin :: Constructor
			public ODBCDriver() throws ClassNotFoundException {
				//register the driver
			...
			public ODBCDriver(String ConnectionString) throws ClassNotFoundException {
				//register the driver
				Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
		...
		//--> Begin Method :: Open
			public void Open() throws Exception {
				if(DriverManager.getConnection(this.ConnectionString) == null){
					this.MyConnection = DriverManager.getConnection(this.ConnectionString);
				}
			}
		//<-- End Method :: Open
