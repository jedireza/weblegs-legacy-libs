...
'/--> Begin Class :: MySQLDriver
	Public Class MySQLDriver 
		...
		'/--> Begin :: Constructor
			Public Sub New() 
				Me.MyConnection = New MySqlConnection()
				Me.SQLCommand = ""
				Me.ConnectionString = ""
				Me.Host = ""
				Me.Username = ""
		...
		'/--> Begin Method :: ExecuteNonQuery
			Public Sub ExecuteNonQuery() 
				Dim MyCommand As MySqlCommand = New MySqlCommand(Me.SQLCommand, Me.MyConnection)
		...
		'/--> Begin Method :: GetDataString
			Public Function GetDataString(RowSeperatedBy As String, FieldsSeperatedBy As String, FieldsEnclosedBy As String, ReturnHeaders As Boolean) As String
				Dim MyAdapter As MySqlDataAdapter = New MySqlDataAdapter(Me.SQLCommand, Me.MyConnection)
		...
		'/--> Begin Method :: GetLastInsertID
			Public Function GetLastInsertID() As String 
				Dim MyAdapter As MySqlDataAdapter = New MySqlDataAdapter("SELECT LAST_INSERT_ID()", Me.MyConnection)
				Dim MyDataSet As DataSet = New DataSet()
				MyAdapter.Fill(MyDataSet, "Results")
				MyAdapter.Dispose()
		...
		'/--> Begin Method :: GetFoundRows
			Public Function GetFoundRows() As Integer 
				Dim MyAdapter As MySqlDataAdapter = New MySqlDataAdapter("SELECT FOUND_ROWS() AS TotalCount", Me.MyConnection)
				Dim MyDataSet As DataSet = New DataSet()
				MyAdapter.Fill(MyDataSet, "Results")
				MyAdapter.Dispose()
